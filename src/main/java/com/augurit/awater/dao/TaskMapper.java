...
public interface TaskMapper {
	...
	//  查询所有的自己有权限任务实例
	List<TaskInstance> findTaskInstanceList(@Param("recieverId") String recieverId, @Param("creatorId") String creatorId, @Param("taskName") String taskName) throws Exception;
	...
	void abandonTaskInstance(@Param("instance") TaskInstance instance) throws Exception;
	//  指派具体买家
	...
	//  查询具体的任务明细
	List<TaskDetail> findTaskDetailList(@Param("user") User user, @Param("instanceId") String instanceId, @Param("taskDetailName") String taskDetailName, @Param("excludeCols") List<String> excludeCols) throws Exception;
	//  更新具体的任务明细
	...
	// 废弃任务明细
	void abandonTaskDetail(@Param("detail") TaskDetail detail) throws Exception;
	// 删除任务明细文件
	void delTaskDetailFiles(@Param("fileIds") List<String> fileIds, @Param("detailId") String detailId) throws Exception;
}
